 ...
 if ( textclass == 1 ) {
   ...
   htmlclass="eng-lang text-muted font-weight-light"
    ...
    if (NR == 1 || (file_name != prev_file && textclass == 1)) {
        print "<tr><td><a href=\"" anchorlink "\">" file_name "</a></td><td><input type=checkbox data-index=" file_name "></td><td><a  href=\"\" onclick=openDpr(\"" sutta "\") >Pi</a>&nbsp;<a class=\"bwLink\"  href=\"\" data-slug=" sutta ">En</a>&nbsp;<a class=\"ruLink\"  href=\"\" data-slug=" sutta ">Ru</a>&nbsp;</td><td><p><span class=\"" htmlclass "\" lang=\"" language "\">" qoute, hiddenlink"</span>"
