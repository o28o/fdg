...
$radiokn = '+КН';
$tooltiponl = 'X Y ... или "(X|Y|...)" включая кавычки. Найдет только тексты содержащие оба и более совпадений X, Y, ... Без этой опции будут собраны тексты которые содержат даже одно совпадение';
$checkboxonl = 'Тлк';
