...
<div style="position: relative;">
  <input name="q" style="z-index: 9;     flex-grow: 1;" type="search" class="form-control rounded-pill searchinput" id="paliauto" placeholder="e.g. Kāyagat or sn56.11" value="<?php echo $q; ?>" multiple>
