...
<div style="position: relative;">
  <input name="q" style="z-index: 9; padding-right: 30px; min-width:280px;" type="search" class="form-control rounded-pill" id="paliauto" placeholder="e.g. Kāyagat or sn56.11" value="<?php echo $q; ?>" multiple>
