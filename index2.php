...
Поиск на Пали и Англ стал намного быстрее. В работе поиск на Русском. Пока искать можно только по всем совпадениям, "определения", "сравнения" и др опции пока недоступны. Если обнаружите ошибки, пожалуйста, <a class="alert-link" href="#contacts"> сообщите через контакты <i class="fa-regular fa-comment"></i></a>
...
Search in Pali and English has become much faster. The search in Russian is in progress. Currently, the search is only available for all matches. If you encounter any errors, please use <a class="alert-link" href="#contacts">contacts to report <i class="fa-regular fa-comment"></i></a>
