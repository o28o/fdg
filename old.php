...
<h1 class="masthead-heading">
    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Good Old <?php echo $tooltiptitle;?>">
        <?php echo $title;?>
    </div>
</h1>
...
<script>
$.ajax({
  url: "/assets/texts/words/ebtWordsVars.txt",
  dataType: "text",
