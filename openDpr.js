document.addEventListener("DOMContentLoaded", function() {
    ...
    dprLinks.forEach(link => {
     ...
     // Жёстко заданные кейсы
    if (/.*bu-pm/.test(slug)) {
    textUrl = "https://www.digitalpalireader.online/_dprhtml/index.html?loc=v.6.0.x.x.x.x.t";
}
if (/.*bi-pm/.test(slug)) {
    textUrl = "https://www.digitalpalireader.online/_dprhtml/index.html?loc=v.6.0.x.x.x.x.t";
}       
...
/* function openDpr(slug) {
    ...
    if (slug === "bu-pm") {
        ...
        textUrl = "https://www.digitalpalireader.online/_dprhtml/index.html?loc=v.6.1.x.x.x.x.t";
    } else {
        console.log("Ссылка не найдена");
        return;
    }
