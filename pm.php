...
<body>
  ...
  <a class="ms-1 toggle-dict-btn">  <img src="/assets/svg/comment.svg" class="dictIcon-sitePages"></img></a>
       ...
       <a class="ms-1 btn-sm btn-secondary rounded-pill text-decoration-none " href="/read/d.html?q=bu-pm&script=devanagari" >bu-pm</a>
      <a class="ms-1 btn-sm btn-secondary rounded-pill text-decoration-none " href="/read/d.html?q=bu-pm&script=devanagari" >bi-pm</a>
