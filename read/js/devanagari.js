...
var rootDevanagaripath = `/assets/texts/th/root/pli/ms/${texttype}/${slugReady}_rootth-pli-ms.json`
 } 
else {
var rootDevanagaripath = `/assets/texts/devanagari/root/pli/ms/${texttype}/${slugReady}_rootd-pli-ms.json`;
 }
...
var rootDevanagaripath = `/assets/texts/th/root/pli/ms/${texttype}/${slug}_rootth-pli-ms.json`
 } 
else {
var rootDevanagaripath = `/assets/texts/devanagari/root/pli/ms/${texttype}/${slug}_rootd-pli-ms.json`;
 }
...
//   console.log(`transData[${segment}]: ${transData[segment]}`);
  //  console.log(`engTransData[${segment}]: ${engTransData[segment]}`);
    if (engTransData[segment] !== transData[segment] && varData[segment] !== undefined) {
      ...
      <span class="pli-lang inputscript-ISOPali" lang="pi">${paliDevanagariData[segment].trim()}${linkToCopy}
	  </span>
...
//      <span class="eng-lang" lang="en">
        ...
        html += `${openHtml}<span id="${anchor}">
      <span class="pli-lang inputscript-ISOPali" lang="pi">${paliDevanagariData[segment].trim()}${linkToCopy}</span>

      <span class="greyedout eng-lang" lang="en">${paliData[segment].trim()}${linkToCopy}
</span><br>
      <font class="variant">
...
.catch(error => {
  ...
  console.log('rootDevanagaripath', rootDevanagaripath);
