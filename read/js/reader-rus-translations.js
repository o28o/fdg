...
//const translatorCapitalized = translator.charAt(0).toUpperCase() + translator.slice(1);
     ...
     <p>
    <span class="pli-lang" lang="pi">Пали <a class="text-decoration-none text-reset" href="/assets/texts/abbr.html?s=ms">MS</a>.</span> <span class="rus-lang" lang="ru"> Перевод: ${translatorforuser}</span>
     </p>
     </div>`;
