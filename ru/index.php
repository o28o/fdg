...
<li class="nav-item mb-3 mx-lg-2"><a class="nav-link py-3 px-0 px-lg-0 rounded" href="#project">О Проекте</a></li>             
...
<div id="spinner" class="justify-content-center mt-8 mb-3"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div></div>
