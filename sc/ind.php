...
<head>
 ...
 <!--   <script>  var link = document.createElement('meta');  link.setAttribute('property', 'og:title');  link.content = document.title;  document.getElementsByTagName('head')[0].appendChild(link);</script> -->   
  <meta property="og:title" content="sc light | find.Dhamma.gift" />
 <meta property="og:description" content="An ultra fast and lightweight interface for localcopy of SuttaCentral texts." />
...
<a href="/diff" title="Compare two suttas" rel="noreferrer"
