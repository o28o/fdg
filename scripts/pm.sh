...
<span class="level5">
<a href="/ru/read/?q=b'$mf'-pm#'$ruleindex'">'$rulename'</a> 
<a href="/ru/read/?q=pli-tv-b'$mf'-vb-'$typeacr$i'#'$vbindex'">vb</a> '$fullruletext'
</span>
</div>'
else 
  echo '<div class="level4">
<span class="level5">
<a href="/ru/read/?q=b'$mf'-pm#'$ruleindex'">'$rulename'</a> '$fullruletext'
</span>
</div>'
